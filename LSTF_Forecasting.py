...
import pandas as pd
# from my_models.tools import norm_data, getDataMatrix
# from my_models.tools import wavelet_noising_column
...
def main():
    ...
    X_wave, Y_wave = getDataMatrix(seq_wave, args.seq_len, args.pred_len, args.stride)
...
def get_representation(args, model_pre, batch_train, batch_train_ori, num_group):
    ...
    for i in range(len(batch_train)):
        ...
        pre_fea = model_pre(split_blocks, 0, 0)
